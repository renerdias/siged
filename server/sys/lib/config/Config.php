...
use root\server\sys\lib\config\Exception\FileNotFoundException;
use root\server\sys\lib\config\Exception\UnsupportedFormatException;
use root\server\sys\lib\config\Exception\EmptyDirectoryException;
...
class Config extends AbstractConfig
{
    ...
    private $supportedFileParsers = array(
        'root\server\sys\lib\config\FileParser\Php',
        'root\server\sys\lib\config\FileParser\Ini',
        'root\server\sys\lib\config\FileParser\Json',
        'root\server\sys\lib\config\FileParser\Xml',
        'root\server\sys\lib\config\FileParser\Yaml'
    );
     ...
     *
     * @return root\server\sys\lib\config\FileParser\FileParserInterface
     *
