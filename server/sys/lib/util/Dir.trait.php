...
/**
 * Trecho de código que concentra os métodos de manipulação de diretórios
 *
 * @package sys/lib
 * @subpackage util
 * @version 0.1
...
trait Dir {
     ...
     * @access public
     * @static
     * @param string $path Determina o local onde será criado a pasta
     * @return {type} Boolean
     */
    public static function dir_create($path = null) {
        return mkdir($path);
    }
    /**
     * Verifica se um diretório exste no path informado
     *
     * @access public
     * @static
     * @param string $path Determina o local onde será criado a pasta
     * @return boolean
     */
    public static function dir_exist($path = null) {
